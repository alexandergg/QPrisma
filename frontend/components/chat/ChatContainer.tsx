            ...
            >
              {suggestions.map((suggestion) => (
                <motion.button
                  ...
                  className="group flex items-center gap-3 text-left text-sm p-3 rounded-xl border border-gray-200 hover:border-amber-200 hover:bg-amber-50/50 transition-colors"
                >
                  <MessageSquare className="w-4 h-4 text-gray-400 group-hover:text-amber-600 flex-shrink-0" />
                  <span className="text-gray-600 group-hover:text-gray-900 flex-1">
                    {suggestion}
                  </span>
                  <ArrowRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-amber-500 opacity-0 group-hover:opacity-100 transition-all" />
                </motion.button>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            ...
            {!hasVideo && (
              <div className="px-6 pb-2">
                <div className="max-w-3xl mx-auto rounded-xl border border-[var(--amber-3)] bg-[var(--amber-1)] px-4 py-2 text-sm text-[var(--amber-11)]">

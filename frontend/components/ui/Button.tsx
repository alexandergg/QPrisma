...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-[var(--surface-elevated)] text-[var(--foreground)] hover:bg-[var(--border)] focus-visible:ring-[var(--border)]',
  ghost:
    'bg-transparent text-[var(--text-secondary)] hover:bg-[var(--surface-elevated)] focus-visible:ring-[var(--border)]',
  danger:
    'bg-[var(--rose-7)] text-white hover:bg-[var(--rose-8)] focus-visible:ring-[var(--rose-7)]',
};

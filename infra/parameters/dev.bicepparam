...
param databricksOutboxCatalog = readEnvironmentVariable('DATABRICKS_OUTBOX_CATALOG', 'dbw_qprisma_dev')
...
param processingBackend = readEnvironmentVariable('PROCESSING_BACKEND', 'celery')

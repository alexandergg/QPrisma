...
param databricksStagingEnabled = bool(readEnvironmentVariable('DATABRICKS_STAGING_ENABLED', 'true'))
param databricksSourceVolumeCatalog = readEnvironmentVariable('DATABRICKS_SOURCE_VOLUME_CATALOG', 'dbw_qprisma_dev')
param databricksSourceVolumeSchema = readEnvironmentVariable('DATABRICKS_SOURCE_VOLUME_SCHEMA', 'video')
param databricksSourceVolumeName = readEnvironmentVariable('DATABRICKS_SOURCE_VOLUME_NAME', 'source_media')
param databricksSourceVolumePrefix = readEnvironmentVariable('DATABRICKS_SOURCE_VOLUME_PREFIX', '')
param processingBackend = readEnvironmentVariable('PROCESSING_BACKEND', 'servicebus')
